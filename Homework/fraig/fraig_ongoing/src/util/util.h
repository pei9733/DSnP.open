...
extern unsigned long long getRandomULL(unsigned long long const& min, unsigned long long const& max);
// extern unsigned long long getRandomULL1(unsigned long long const& min, unsigned long long const& max);
